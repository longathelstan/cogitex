...
import { Flame, Trophy, TrendingUp, Quote, ArrowRight } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-500 rounded-3xl p-8 text-white shadow-xl shadow-primary-200">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            ...
            <p className="text-primary-100 opacity-90">Your critical thinking engine is warming up.</p>
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10">
                ...
                <span className="font-bold">Level {Math.floor(user.motivationScore / 20)} Scholar</span>
              </div>
            </div>
          </div>

          <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20 min-w-[200px] text-center">
            <span className="text-sm text-primary-100 uppercase tracking-wider font-semibold">Motivation Score</span>
            ...
            <div className="flex items-center justify-center gap-1 text-xs text-primary-100 mt-2">
              <TrendingUp size={14} /> Top 5% of users
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-bold text-slate-700 text-lg">Performance Trend</h3>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden">
             ...
             <div className="relative z-10">
               <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">Daily Goal</h3>
               ...
               <span className="text-xs text-slate-500">75% Complete</span>
             </div>
          </div>
          ...
          <div className="bg-indigo-50 p-6 rounded-3xl border border-indigo-100 shadow-sm">
            ...
            <p className="text-indigo-900 italic font-medium">"The unexamined life is not worth living."</p>
