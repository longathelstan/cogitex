    ...
    <div className="min-h-screen bg-white font-sans text-slate-800 flex flex-col">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-slate-100 z-50 h-16 flex items-center px-6 lg:px-12 justify-between">
        ...
        <div className="hidden md:flex gap-6 text-sm font-medium text-slate-600">
          ...
          <a href="#community" className="hover:text-primary-600 transition">Cộng đồng</a>
        </div>
        <button
          onClick={onStart}
      ...
      <header className="flex-1 flex flex-col items-center justify-center pt-32 pb-20 px-6 text-center bg-gradient-to-b from-primary-50/50 to-white">
        <div className="animate-fade-in space-y-6 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.1]">
            Đừng chỉ dùng AI. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-indigo-600">Hãy làm chủ tư duy.</span>
          </h1>

          <p className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed">
            Cognitex giúp bạn chuyển từ việc tiêu thụ AI thụ động sang tư duy phản biện chủ động. Theo dõi tâm trạng, suy ngẫm về các câu trả lời của AI và phát triển trí tuệ của bạn.
          </p>
        ...
        <div className="mt-16 w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 animate-slide-up opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
          ...
          <div className="bg-white p-6 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-start text-left hover:-translate-y-1 transition-transform duration-300">
            ...
            <h3 className="font-bold text-lg text-slate-800 mb-2">Gương tư duy</h3>
            <p className="text-sm text-slate-500">Suy ngẫm về các tương tác hàng ngày của bạn với AI. Bạn có đặt câu hỏi cho câu trả lời không? Bạn có tìm hiểu sâu hơn không?</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-start text-left hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden">
            ...
            <h3 className="font-bold text-lg text-slate-800 mb-2 relative z-10">Máy quét tâm trạng</h3>
            <p className="text-sm text-slate-500 relative z-10">Phân tích năng lượng và mức độ tập trung của bạn bằng AI để tối ưu hóa các phiên học tập.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-start text-left hover:-translate-y-1 transition-transform duration-300">
            ...
            <h3 className="font-bold text-lg text-slate-800 mb-2">Nhịp đập học tập</h3>
            <p className="text-sm text-slate-500">Phân tích trực quan về sự phát triển tư duy phản biện và thói quen học tập của bạn theo thời gian.</p>
          </div>
      ...
      <footer className="py-8 text-center text-slate-400 text-sm border-t border-slate-100 bg-slate-50">
        <p>&copy; 2024 Cognitex Inc. Xây dựng cho những nhà tư tưởng của ngày mai.</p>
      </footer>
    </div>
  );
};
