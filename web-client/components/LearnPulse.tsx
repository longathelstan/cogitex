  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in pb-20">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-slate-800">Phân tích Nhịp đập học tập</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        />
        <StatCard
          title="Suy ngẫm đã ghi"
          value="28"
          icon={<BrainCircuit size={24} />}
          sub="Thói quen đều đặn"
        />
        <StatCard
          title="Chủ đề đã học"
          value="6"
      ...
      <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
        <h3 className="font-bold text-slate-800 text-lg mb-6">Phân bổ phát triển kỹ năng</h3>
        <div className="h-80">
