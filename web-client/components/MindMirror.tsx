...
const MindMirror: React.FC = () => {
  ...
  const chartData = analysis ? [
    { subject: 'Confidence', A: analysis.scores.confidence, fullMark: 100 },
    { subject: 'Discipline', A: analysis.scores.discipline, fullMark: 100 },
    { subject: 'Critical Thinking', A: analysis.scores.criticalThinking, fullMark: 100 },
  ] : [];
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
          <div className="flex items-center gap-2 mb-6">
             ...
             <h2 className="text-xl font-bold text-slate-800">Mood Scanner</h2>
          </div>
          ...
          <div className="space-y-4 mb-6">
            <div>
              <div className="flex justify-between text-sm font-medium text-slate-600 mb-1">
                <span className="flex items-center gap-1"><Zap size={16} /> Energy</span>
            ...
            <div>
              <div className="flex justify-between text-sm font-medium text-slate-600 mb-1">
                <span className="flex items-center gap-1"><Target size={16} /> Focus</span>
          ...
          >
            {isMoodLoading ? <Loader2 className="animate-spin" size={20} /> : "Check In"}
          </button>
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 h-full flex flex-col">
          <div className="flex items-center gap-2 mb-4">
             ...
             <h2 className="text-xl font-bold text-slate-800">Reflection Wall</h2>
          </div>
          
          <p className="text-sm text-slate-500 mb-4">What did you learn today, and more importantly, what did you <span className="font-semibold text-indigo-600">question</span> today?</p>
          ...
          <textarea
            ...
            rows={5}
            placeholder="I was using ChatGPT to solve a math problem, but I noticed..."
          ...
          <div className="flex justify-end mb-6">
            ...
            >
              {isAnalysisLoading ? <Loader2 className="animate-spin" size={18} /> : <>Analyze <Send size={16} /></>}
            </button>
          </div>
          ...
          {analysis && (
            <div className="flex-1 bg-slate-50 rounded-2xl p-4 animate-fade-in border border-slate-100">
               ...
               <div className="space-y-2">
                 <h4 className="font-semibold text-slate-800 text-sm">AI Feedback:</h4>
